...
type driverJobResponse struct {
	...
	DepartureTime    time.Time `json:"departureTime" time_format:"2006-01-02 3:04PM"`
	DestinationPlace string    `json:"destinationPlace"`
	DestinationTime  time.Time `json:"destinationTime" time_format:"2006-01-02 3:04PM"`
...
type createDriverJobForm struct {
	...
	DepartureTime    time.Time `form:"departureTime" time_format:"2006-01-02 3:04PM"`
	DestinationPlace string    `form:"destinationPlace"`
	DestinationTime  time.Time `form:"destinationTime" time_format:"2006-01-02 3:04PM"`
